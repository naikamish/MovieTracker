...
public class FXMLDocumentController implements Initializable {
    ...
    @FXML private AnchorPane movieTableView;
    
    @FXML private TextField SearchTextField;
    
    @FXML private Button SearchButton, AddMovieButton;
    
    @FXML private DatePicker ViewDatePicker;
    
    @FXML private VBox SearchResultsBox, SingleMovieResult; 
